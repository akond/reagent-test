(defproject reagent-test "0.1.0-SNAPSHOT"
	...
	:cljsbuild {:builds
				[{:id           "dev"
				  ...
				  ;; into your build
				  :figwheel     {:on-jsload "reagent-test.core/on-js-reload"
				  ...
				  :compiler     {:main                 reagent-test.core
				 ...
				 {:id           "min"
				  :source-paths ["src"]
				  :compiler     {:output-to     "resources/public/js/compiled/reagent_test.js"
								 :main          reagent-test.core
